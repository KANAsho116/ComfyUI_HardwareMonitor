...
class CrystoolsMonitor {
    constructor() {
        ...
        Object.defineProperty(this, "createSettingsTransferSpeed", {
            ...
            writable: true,
            value: () => {
                this.monitorVRAMSpeedElement = {
                    id: 'Crystools.ShowVramSpeed',
                    name: 'VRAM Transfer Speed',
                    category: ['Crystools', this.menuPrefix + ' Transfer Speed', 'VRAM Speed'],
                    type: 'boolean',
                    label: 'VRAM',
                    symbol: ' MB/s',
                    defaultValue: false,
                    ...
                    isTransferSpeed: true,
                    maxSpeed: 50000,
                    onChange: async (value) => {
                        await this.updateServer({ switchTransferSpeed: value || app.extensionManager.setting.get(this.monitorSharedSpeedElement.id) });
                        this.updateWidget(this.monitorVRAMSpeedElement);
                    },
                };
                this.monitorSharedSpeedElement = {
                    id: 'Crystools.ShowSharedSpeed',
                    name: 'Shared GPU Memory Speed',
                    category: ['Crystools', this.menuPrefix + ' Transfer Speed', 'Shared Speed'],
                    type: 'boolean',
                    label: 'Shared',
                    symbol: ' MB/s',
                    defaultValue: false,
                    ...
                    htmlMonitorSliderRef: undefined,
                    htmlMonitorLabelRef: undefined,
                    cssColor: Colors.SHARED_SPEED,
                    isTransferSpeed: true,
                    maxSpeed: 50000,
                    onChange: async (value) => {
                        await this.updateServer({ switchTransferSpeed: value || app.extensionManager.setting.get(this.monitorVRAMSpeedElement.id) });
                        this.updateWidget(this.monitorSharedSpeedElement);
                    },
                };
            }
        });
        Object.defineProperty(this, "createSettings", {
            ...
            value: () => {
                ...
                app.ui.settings.addSetting(this.monitorVRAMSpeedElement);
                app.ui.settings.addSetting(this.monitorSharedSpeedElement);
        ...
        Object.defineProperty(this, "setup", {
            ...
            value: () => {
                ...
                app.menu?.settingsGroup.element.before(this.crystoolsButtonGroup.element);
                this.monitorUI = new MonitorUI(this.crystoolsButtonGroup.element, this.monitorCPUElement, this.monitorRAMElement, this.monitorHDDElement, this.monitorGPUSettings, this.monitorVRAMSettings, this.monitorTemperatureSettings, this.monitorVRAMSpeedElement, this.monitorSharedSpeedElement, currentRate);
